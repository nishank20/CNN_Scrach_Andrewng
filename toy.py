...
class ConvLayer(object):
    ...
    def __init__(self, input_shape, filter_size, stride, num_filters, padding = 0):
        ...
        self.z_values = np.zeros((int(self.num_filters), int(self.output_dim1), int(self.output_dim2)))
        self.output = np.zeros((int(self.num_filters), int(self.output_dim1), int(self.output_dim2)))
    ...
    def convolve(self, input_neurons):
        ...
        self.z_values = self.z_values.reshape((int(self.num_filters),int(self.output_dim1 * self.output_dim2)))
        self.output = self.output.reshape((int(self.num_filters), int(self.output_dim1 * self.output_dim2)))
        ...
        self.z_values = self.output.reshape((int(self.num_filters), int(self.output_dim1), int(self.output_dim2)))
        self.output = self.output.reshape((int(self.num_filters), int(self.output_dim1), int(self.output_dim2)))
...
class PoolingLayer(object):
    ...
    def __init__(self, input_shape, poolsize = (2,2)):
        ...
        self.output = np.empty((int(self.depth), int(self.height_out), int(self.width_out)))
        self.max_indices = np.empty((int(self.depth), int(self.height_out), int(self.width_out), 2))

    def pool(self, input_image):

        self.pool_length1d = int(self.height_out * self.width_out)

        self.output = self.output.reshape((int(self.depth), int(self.pool_length1d)))
        self.max_indices = self.max_indices.reshape((int(self.depth), int(self.pool_length1d), 2))
        ...
        self.output = self.output.reshape((int(self.depth), int(self.height_out), int(self.width_out)))

        self.max_indices = self.max_indices.reshape((int(self.depth), int(self.height_out), int(self.width_out), 2))
